...
namespace advent09
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Run Program
            // input_signal = 1 for puzzle 1 and input_signal = 2 for puzzle 2
            // pointer = 0
            Int64 output = ProgramIntcode(int_array, 2, 0);
        ...
        static Int64 ProgramIntcode(Int64[] program_array, int input_signal, Int64 pointer)
        {
